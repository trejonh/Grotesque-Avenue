...
namespace Horse.Engine.MovingSprites
{
    /// <summary>
    ...
    public abstract class Moveable : SpriteAnimated {
        ...
        private Dictionary<Direction, Animation.AnimationFrames> AnimationsDirections { get; set; }
        ...
        {
            Name = name;
            AnimationsDirections = new Dictionary<Direction, Animation.AnimationFrames>();
        }
        ...
        public void SetAnimationFrames(Dictionary<Direction, Animation.AnimationFrames> frames) => AnimationsDirections = frames;
        ...
        public void AddAnimation(Direction direction, int firstFrame, int lastFrame) => AnimationsDirections.Add(direction,new Animation.AnimationFrames(firstFrame,lastFrame));
        ...
        /// </summary>
        /// <returns></returns>
        protected bool CanIMove(Time time)
        {
            _currentWaitTime += time.AsSeconds();
